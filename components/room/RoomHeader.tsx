...
import { Check, Copy, Eraser, LogOut, Users } from 'lucide-react'
...
> = {
  ...
  // "Secure" implied E2EE, which this app does not do.
  // The socket is TLS when deployed behind HTTPS, but the server
  // still processes plaintext.
  connected: {
    text: 'TLS Connected',
...
/**
 * Shown only while the server reports degraded persistence.
 * Deliberately low-key: live messaging is unaffected, and
    ...
    <header className="flex h-16 shrink-0 items-center justify-between gap-3 border-b border-[var(--color-line)] bg-[rgba(8,9,11,0.72)] px-4 backdrop-blur-xl sm:px-6">
      ...
      <div className="flex items-center gap-1.5">
        ...
        <button
          ...
          aria-label="Clear my view of the chat"
          title="Clear my view"
        >
